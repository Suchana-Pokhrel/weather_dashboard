...
// in weatherapi/test/helpers/test_helpers.dart.
...
import 'package:weatherapi/services/api_service.dart' as _i8;
import 'package:weatherapi/services/location_service.dart' as _i9;
...
class MockApiService extends _i1.Mock implements _i8.ApiService {
  ...
  @override
  _i6.Future<Map<String, dynamic>> fetchForecast(String? location) =>
      (super.noSuchMethod(
        Invocation.method(
          #fetchForecast,
          [location],
  ...
  @override
  _i6.Future<Map<String, dynamic>> getCurrentWeather(String? location) =>
      (super.noSuchMethod(
        Invocation.method(
          #getCurrentWeather,
          [location],
  ...
  @override
  _i6.Future<List<dynamic>> getHourlyForecast(String? location) =>
      (super.noSuchMethod(
        Invocation.method(
          #getHourlyForecast,
          [location],
  ...
  @override
  _i6.Future<Map<String, dynamic>> getDailyForecast(String? location) =>
      (super.noSuchMethod(
        Invocation.method(
          #getDailyForecast,
          [location],
  ...
  @override
  _i6.Future<List<dynamic>> searchLocation(String? query) =>
      (super.noSuchMethod(
        Invocation.method(
          #searchLocation,
          [query],
...
class MockLocationService extends _i1.Mock implements _i9.LocationService {
  @override
  _i6.Future<bool> checkPermission() => (super.noSuchMethod(
        Invocation.method(
          #checkPermission,
          [],
        ),
  ...
  @override
  _i6.Future<_i10.Position?> getCurrentLocation() => (super.noSuchMethod(
        Invocation.method(
          #getCurrentLocation,
          [],
        ),
        returnValue: _i6.Future<_i10.Position?>.value(),
        returnValueForMissingStub: _i6.Future<_i10.Position?>.value(),
      ) as _i6.Future<_i10.Position?>);

  _i6.Future<String> cityNameFromCoords(
    double? lat,
    double? lon,
  ) =>
      (super.noSuchMethod(
